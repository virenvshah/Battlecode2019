...
public class PriorityQueue {
   ...
   protected VP[] d;
   protected int size;
   protected HashMap<TileNode, Integer> map;
   String log_message = "";
   ...
   public PriorityQueue(boolean isMin) {
      isMinHeap= isMin;
      d= new VP[500];
      map= new HashMap<TileNode, Integer>();
   }

   /** A VP object houses a value and a priority. */
   class VP {
      TileNode val;   // The value
   ...
   public void add(TileNode v, int p) throws IllegalArgumentException {
    ...
    */
   public int compareToP(int p1, int p2) {
      if (p1 == p2) return 0;
      if (isMinHeap) {
         if (p1 < p2) {
            return 1;
   ...
   public int compareTo(int m, int n) {
      return compareToP(d[m].priority, d[n].priority);
   }
    ...
    */
   public void updatePriority(TileNode v, int p) {
