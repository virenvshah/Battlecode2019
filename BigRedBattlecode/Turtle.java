...
public class Turtle {
   /**
    * Master function for the turtle strategy
    */
   public static Action turtle(MyRobot myRobot) {
   ...
   /**
    * Makes an action for a castle robot
    */
   private static Action castle(MyRobot myRobot) {
      if (myRobot.turn > 50 && myRobot.turn % 15 == 0) {
         Castle.adjustKarbLimit(myRobot, 90);
      }
      ...
      if (myRobot.karbonite >= 25 + myRobot.karbLimit) {
         ...
         if (myRobot.pilgrimsProduced < myRobot.numKarbo / 5 && myRobot.prophetsProduced % 2 == 1) {
            BuildAction pilgrim = Castle.producePilgrim(myRobot);
            if (pilgrim != null) {
               return pilgrim;
            }
   ...
   /**
    * Makes an action for a preacher robot
    */
   public static Action preacher(MyRobot myRobot) {
      ...
      myRobot.log("Castle loc 2" + myRobot.castleLoc.toString());
      ...
      myRobot.log("Castle loc 3" + myRobot.castleLoc.toString());
   ...
   /**
    * Makes an action for a prophet robot
    */
   private static Action prophet(MyRobot myRobot) {
      ...
      for (Robot r : myRobot.visibleRobots) {
         // if given a signal to move by a church or castle then move randomly
         if ((r.unit == myRobot.SPECS.CHURCH || r.unit == myRobot.SPECS.CASTLE) && r.signal == 50000) {
            myRobot.attackMode = true;
         }  
      }
   ...
   /**
    * Makes an action for a pilgrim robot
    */
   private static Action pilgrim(MyRobot myRobot) {
      ...
      if (!myRobot.closestNode.location.equals(myLoc) && 
               myRobot.me.karbonite < myRobot.karbCapacity) { 
      ...
      if (myRobot.structLoc == null && myRobot.me.karbonite >= myRobot.karbCapacity) {
         ...
         if (tup != null) {
            ...
            for (Robot r : visibleAllyTroops) {
               ...
               if(MapFunctions.radiusDistance(rLoc, myLoc) <= 2) {
                  ...
                  return myRobot.give(toAlly.x, toAlly.y, myRobot.me.karbonite, 0);
               }
            }
         }
      }
      ...
      if(myRobot.structLoc==null && (myRobot.karbonite >= 
               myRobot.karbCapacity + myRobot.karbLimit) && !myRobot.closeToBase){
